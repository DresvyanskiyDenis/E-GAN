...
from GAN_training.data_utils import load_AffectNet_labels, get_tensorflow_image_loader, scale_image
...
def main():
    ...
    path_to_data="E:\\Databases\\AffectNet\\prepared\\train\\resized"
    # params for training
    latent_dim = 128
